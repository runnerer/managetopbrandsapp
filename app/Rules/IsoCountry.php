...
class IsoCountry implements Rule
{
    /**
     * List of valid ISO-2 country codes.
     */
    protected $validCountries = [
        ...
        'GM', 'GN', 'GP', 'GQ', 'GR', 'GT', 'GU', 'GW', 'GY', 'HK', 'HM', 'HN', 'HR', 'HT', 'HU', 'ID', 'IE',
        ...
        'NZ', 'OM', 'PA', 'PE', 'PF', 'PG', 'PH', 'PK', 'PL', 'PM', 'PN', 'PR', 'PT', 'PW', 'PY', 'QA', 'RE',
    ...
    {
        return in_array(strtoupper($value), $this->validCountries);
    }
    ...
    {
        return 'The :attribute must be a valid ISO-2 country code.';
    }
}
